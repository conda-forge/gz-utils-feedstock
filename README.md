...
Once the `conda-forge` channel has been enabled, `gz-utils, gz-utils2, libgz-utils, libgz-utils2` can be installed with `conda`:

```
conda install gz-utils gz-utils2 libgz-utils libgz-utils2
```

or with `mamba`:

```
mamba install gz-utils gz-utils2 libgz-utils libgz-utils2
```
